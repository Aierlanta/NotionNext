...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Alice Aierlanta', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '乱七八糟之国的原住民', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'blog.aierlanta.net', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'alice@soft.moe', // 邮箱地址 例如mail@tangly1024.com
  ...
  WIDGET_PET_LINK:
    ...
    'https://raw.githubusercontent.com/imuncle/live2d/master/model/dollsfrontline/kp31_310/destroy/model.json', // 挂件模型地址 live2d 地址 @see https://github.com/xiazeyu/live2d-widget-models
